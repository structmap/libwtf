...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wtf_h.C_POINTER.withName("__routine"),
        wtf_h.C_POINTER.withName("__arg"),
        wtf_h.C_POINTER.withName("__next")
    ...
    public final static class __routine {
        ...
        private static final MethodHandle UP$MH = wtf_h.upcallHandle(__routine.Function.class, "apply", $DESC);
